...
const Landing = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-background via-background to-primary/10 flex items-center justify-center px-4 overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        <div className="mb-8 animate-fade-in">
          <AnimatedLogo size="lg" className="mb-6 mx-auto" />
        </div>
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto animate-slide-up font-montserrat">
        ...
        {isAuthenticated ? (
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {user?.userType === 'organizer' ? (
              <Button 
                ...
                variant="glow" 
                size="lg" 
                className="px-8 py-6 text-xl group animate-scale-in button-glow transition-all duration-500 hover:scale-105 transform-gpu shadow-lg hover:shadow-xl"
                style={{
          ...
          <Button 
            ...
            variant="glow" 
            size="lg" 
            className="px-12 py-6 text-xl group animate-scale-in button-glow transition-all duration-500 hover:scale-105 transform-gpu shadow-lg hover:shadow-xl"
            style={{
              transition: 'all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)'
            }}
          >
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16 max-w-2xl mx-auto">
          <div className="glass-card p-6 text-center hover-glow rounded-xl shadow-md transition-shadow duration-300">
