...
interface TicketCardProps {
  ticket: Ticket;
  onTransferred?: () => void; // Parent refreshes ticket list after transfer
}

const TicketCard: React.FC<TicketCardProps> = ({ ticket, onTransferred }) => {
  ...
  // QR encodes the full ticket payload — scanner reads this
    ...
    <>
      <Card className="glass-card">
        ...
        <CardContent className="flex flex-col items-center">
          ...
          <div ref={qrContainerRef} className="bg-white p-4 rounded-xl mb-4">
            <QRCode
              value={qrValue}
              size={200}
        ...
        <CardFooter className="flex gap-2">
          ...
          {/* Only show transfer for valid tickets */}
          {ticket.status === 'valid' && (
