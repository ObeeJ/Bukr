...
-- DROP first to clear any partial state from a previous failed run.
...
CREATE INDEX idx_feedback_user_type  ON user_feedback (user_type);
CREATE INDEX idx_feedback_journey    ON user_feedback (journey);
